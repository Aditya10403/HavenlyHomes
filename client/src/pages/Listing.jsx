        ...
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            <p className="text-2xl font-semibold flex">
              {listing.name} - <FaRupeeSign className="self-center text-2xl" />{" "}
              {listing.offer
            ...
            <div className="flex gap-4">
              <p className="bg-red-900 w-full max-w-[150px] text-white text-center p-3 rounded-md">
                {listing.type === "rent" ? "For Rent" : "For Sale"}
              </p>
              {listing.offer && (
                <p className="bg-green-900 w-full max-w-[150px] text-white items-center p-3 rounded-md text-normal flex">
                  <FaRupeeSign className=" text-sm" />{+listing.regularPrice - +listing.discountPrice} OFF
                </p>
              )}
            </div>

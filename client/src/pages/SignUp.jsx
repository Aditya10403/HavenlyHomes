          ...
          <div className="flex items-center justify-center px-1 py-2 md:px-2 md:py-8">
            <div className="sm:w-[90%] md:w-[80%]">
              ...
              <form onSubmit={handleSubmit} className="mt-3 md:mt-8">
                <div className="space-y-3 md:space-y-5">
                  ...
                  <div>
                    <button
                      disabled={loading}
                      className="inline-flex w-full items-center justify-center rounded-md bg-black px-1 py-1 md:px-3.5 md:py-2.5 font-semibold leading-7 text-white hover:bg-black/80
                    active:bg-black/50"
                    >
              ...
              <div className="mt-3 mb-2 space-y-3">
                <button
                  type="button"
                  className="relative inline-flex w-full items-center justify-center rounded-md border border-gray-400 bg-white px-1 py-1 md:px-3.5 md:py-2.5 font-semibold text-gray-700 transition-all duration-200 hover:bg-gray-100 hover:text-black focus:bg-gray-100 focus:text-black focus:outline-none
                active:bg-white/60"
                >
